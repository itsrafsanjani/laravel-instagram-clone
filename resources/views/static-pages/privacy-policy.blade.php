                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in {{ config('app.name') }}. This
                        ...
                        <h2>Log Files</h2>
                        <p>{{ config('app.name') }} follows a standard procedure of using log files. These files log visitors when they
                        ...
                        <p>Like any other website, {{ config('app.name') }} uses 'cookies'. These cookies are used to store information
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                            that are used in their respective advertisements and links that appear on {{ config('app.name') }}, which are
                        ...
                        <p>Note that {{ config('app.name') }} has no access to or control over these cookies that are used by third-party
                            advertisers.</p>
                        <h2>Third Party Privacy Policies</h2>
                        <p>{{ config('app.name') }}'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
